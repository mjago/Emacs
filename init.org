...
# #+BABEL: :results silent !!!Doesn't work 
#+STARTUP: overview
...
(eval-after-load "color-theme"
  '(progn
;; doesn't work     (setq color-theme-directory "~/.emacs.d/martyn/color-themes-added")
      (color-theme-initialize)))
;;     (color-theme-hober)))
...
;;  #               (concat dotfiles-dir  "martyn/lilypond/"))
;;  #  (add-to-list 'load-path
;;  #               (concat dotfiles-dir  "martyn/martyn/lilypond-hook"))
;;  #  (require 'ob-lilypond)
...
** DONE Setup MacGPG2 (for gpg) on mac OSX
